...
interface ChatRepository: JpaRepository<Chat, Long> {
    ...
    /**
     * Returns [Boolean] based on whether a [Chat] is found in the chats that the [com.chatpg.domain.account.Account] has
    ...
    @Modifying
    @Query("UPDATE Chat c SET c.model = :model WHERE publicId = :publicId")
    fun qUpdateModelByPublicId(publicId: UUID, model: AiModel): Long
